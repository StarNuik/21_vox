...
void VertexBuffers::Init() {
	...
	_buffers[MultiTop] = new float[48] {
		-.5f,  1.f,  .0f,   0.f, 1.f, 0.f, 0.25f,  1.f,
		-.5f,  1.f, -1.f,   0.f, 1.f, 0.f, 0.25f,  0.5f,
		.5f,   1.f, -1.f,   0.f, 1.f, 0.f, 0.f,  0.5f,
	...
	_buffers[MultiBottom] = new float[48] {
		-.5f,  .0f,  .0f,   0.f, -1.f, 0.f, 0.25f,  1.f,
		.5f,   .0f, -1.f,   0.f, -1.f, 0.f, 0.25f,  0.5f,
		-.5f,  .0f, -1.f,   0.f, -1.f, 0.f, 0.5f,  0.5f,

		.5f,   .0f, -1.f,   0.f, -1.f, 0.f, 0.5f,  0.5f,
		-.5f,  .0f,  .0f,   0.f, -1.f, 0.f, 0.5f,  1.f,
		.5f,   .0f,  .0f,   0.f, -1.f, 0.f, 0.25f,  1.f,
	};
	_buffers[MultiRight] = new float[48] {
		.5f,   1.f,  .0f,   1.f, 0.f, 0.f, 0.5f,  0.5f,
		.5f,   .0f, -1.f,   1.f, 0.f, 0.f, 0.75f, 0.f,
		.5f,   .0f,  .0f,   1.f, 0.f, 0.f, 0.5f,  0.f,

		.5f,   .0f, -1.f,   1.f, 0.f, 0.f, 0.75f, 0.f,
		.5f,   1.f,  .0f,   1.f, 0.f, 0.f, 0.5f,  0.5f,
		.5f,   1.f, -1.f,   1.f, 0.f, 0.f, 0.75f, 0.5f,
	};
	_buffers[MultiLeft] = new float[48] {
		-.5f,  .0f, -1.f,   -1.f, 0.f, 0.f,	 0.f,  0.f,
		-.5f,  1.f, -1.f,   -1.f, 0.f, 0.f,	 0.f,  0.5f,
		-.5f,  1.f,  .0f,   -1.f, 0.f, 0.f,	 0.25f,  0.5f,

		-.5f,  1.f,  .0f,   -1.f, 0.f, 0.f,	 0.25f,  0.5f,
		-.5f,  .0f,  .0f,   -1.f, 0.f, 0.f,	 0.25f,  0.f,
		-.5f,  .0f, -1.f,   -1.f, 0.f, 0.f,	 0.f,  0.f,
	};
	_buffers[MultiFront] = new float[48] {
		...
		.5f,   1.f,  .0f,   0.f, 0.f, 1.f,	0.25f,  0.5f,
		.5f,   .0f,  .0f,   0.f, 0.f, 1.f,	0.25f,  0.f,
		-.5f,  .0f,  .0f,   0.f, 0.f, 1.f,	0.5f,  0.f,
	};
	_buffers[MultiBack] = new float[48] {
		-.5f,  1.f, -1.f,   0.f, 0.f, -1.f, 0.5f,  1.f,
		-.5f,  .0f, -1.f,   0.f, 0.f, -1.f, 0.5f,  .5f,
		.5f,   .0f, -1.f,   0.f, 0.f, -1.f, 0.75f,  .5f,

		.5f,   .0f, -1.f,   0.f, 0.f, -1.f, 0.75f,  0.5f,
